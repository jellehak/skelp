...
export const COMMANDS = [
  {
    ...
    execute: async ({ shell, print }) => {
      const text = [
        ...
        '  {yellow-fg}/config set <k> <v>{/yellow-fg}  Set a configuration setting (server, primaryModel, tone, userSystem, autoApprove). Use server="auto" to re-trigger provider detection on next launch.',
